...
// this is used by admin to view teacher details
public class ViewTeacherDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // following code is used to get teacher courses from database
        ...
        //listener for edit button - opens EditTeacherActivity
        ...
        // listener for delete button -> deletes teacher from database
    ...
    // the following method places information regarding teacher in text boxes
    void init() {
