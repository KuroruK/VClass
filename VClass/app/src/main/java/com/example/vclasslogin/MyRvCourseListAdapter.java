...
public class MyRvCourseListAdapter extends RecyclerView.Adapter<MyRvCourseListAdapter.MyViewHolder> {
    Context c;
    List<Courses> courseList; // will contain a list of all courses
    ...
    // setting row layout for courses
    @NonNull
    @Override
    ...
    // placing some specific course information in a row
    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        // if a course is selected from list, a new Activity that shows the selected courses' details is opened.
        if (holder.rl != null) {
    ...
    // returns number of courses in list
    @Override
    ...
    // class to define elements of course row
